...
import styleScss from './my-segundoStyle';

export class MySegundo extends LitElement {
    static get styles(){
        return[styleScss]
    }
    ...
    render(){
        ...
        <div class="container">
            <title>Area</title>
            <div class="operacion">
                <div class="child">Area Triangulo</div>
                <div class="child-1">
                    <form>
                        <div class="child-2">
                            <label>Base</label>
...
customElements.define('my-segundo',MySegundo)
